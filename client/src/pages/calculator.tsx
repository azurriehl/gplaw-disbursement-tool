                    ...
                    <tr>
                      ...
                      <td className="px-6 py-4">
                        <Button
                          ...
                          variant="ghost"
                          className="text-firm-primary border-0 button-hover-grey hover:text-firm-primary w-full justify-start"
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <Button 
                onClick={handleReset} 
                variant="ghost"
                className="w-full text-firm-primary border-0 button-hover-grey hover:text-firm-primary font-semibold"
